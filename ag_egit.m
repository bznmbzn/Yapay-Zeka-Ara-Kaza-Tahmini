...
hold on;
h2=plot(sonuc,'g:');
xlabel('Eğitilen Girişler','FontSize',10,'Color','b');
ylabel('Değer','FontSize',10,'Color','b');
ylim([-0.01 max(cikislar(:))+0.01]);
legend([h1(1),h2(1)],'Beklenen','Ağ Çıktıları','Location','northwest','Orientation','horizontal');
